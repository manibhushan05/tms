...
class ReconcileComponent extends React.Component {
  constructor(props) {
    super(props);
    this.reconcileElement = null;
    this.state = {
  ...
  componentDidMount() {
    const scriptSrcArr = ["/static/vendor/datatable/Bootstrap3/DataTables/DataTables-1.10.16/js/jquery.dataTables.min.js",
      ...
      "/static/aaho/js/team/reconcile.js",
    ];
    var that = this;
  ...
  render() {
    return (
      <div className='Container'
        ref={reconcileElement => (this.reconcileElement = reconcileElement)}
