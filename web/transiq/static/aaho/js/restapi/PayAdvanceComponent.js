...
class PayAdvanceComponent extends React.Component {
  constructor(props) {
    super(props);
    this.payAdvanceElement = null;
    this.state = {
  ...
  componentDidMount() {
    const scriptSrcArr = ["/static/vendor/datatable/Bootstrap3/DataTables/DataTables-1.10.16/js/jquery.dataTables.min.js",
      ...
      "/static/aaho/js/team/pay_advance.js",
    ];
    var that = this;
    ...
    setTimeout(function () {
      $(this.payAdvanceElement).find('[data-my-script]').each(function forEachScript() {
  ...
  render() {
    return (
      <div className='Container'
        ref={payAdvanceElement => (this.payAdvanceElement = payAdvanceElement)}
