...
class ProcessPaymentComponent extends React.Component {
    constructor(props) {
        super(props);
        this.processPaymentElement = null;
        this.state = {
 ...
 //scripts not load from html string need to load from following
    componentDidMount() {
      ...
      "/static/vendor/parsley/js/parsley.min.js",
        "/static/aaho/js/team/process_payment.js",
      ];
      var that = this;
    ...
    render() {
        return (
          <div className='Container'
            ref={processPaymentElement => (this.processPaymentElement = processPaymentElement)}
