# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-07-14 16:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('driver', '0005_auto_20170706_1720'),
    ]

    operations = [
        migrations.CreateModel(
            name='WaytrackerGPSDevice',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel', models.CharField(blank=True, max_length=10, null=True)),
                ('nearest_site', models.CharField(blank=True, max_length=150, null=True)),
                ('nearest_location', models.CharField(blank=True, max_length=150, null=True)),
                ('idle_time', models.CharField(blank=True, max_length=20, null=True)),
                ('driver_name', models.CharField(blank=True, max_length=50, null=True)),
                ('driver_number', models.CharField(blank=True, max_length=20, null=True)),
                ('driving_licence_number', models.CharField(blank=True, max_length=20, null=True)),
                ('vehicle_number', models.CharField(blank=True, max_length=40, null=True)),
                ...
                ('device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='device_logs', to='driver.WaytrackerGPSDevice')),
            ],
            options={
