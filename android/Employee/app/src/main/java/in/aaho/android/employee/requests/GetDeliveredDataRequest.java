 ...
 * Created by Suraj M
 */
public class GetDeliveredDataRequest extends ApiGetRequest {

    public GetDeliveredDataRequest(String url, Map<String, String> params, ApiResponseListener listener) {
