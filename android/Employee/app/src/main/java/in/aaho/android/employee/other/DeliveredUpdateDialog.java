...
public class DeliveredUpdateDialog extends Dialog implements
    ...
    private String[] commentList =  {
            "Previous trip incomplete","On the way to loading point",
            "Waiting as loading point","Loading ongoing"
    };
    private IOnDeliveredUpdateListener mIOnDeliveredUpdateListener;

    public interface IOnDeliveredUpdateListener {
        void onDeliveredUpdateClickedListener(String status, String comment);
    }

    public DeliveredUpdateDialog(Context context, ArrayList<String> statusList,
                                 IOnDeliveredUpdateListener iOnDeliveredUpdateListener) {
        super(context);
        this.mContext = context;
        this.mStatusList = statusList;
        this.mIOnDeliveredUpdateListener = iOnDeliveredUpdateListener;
    }
    ...
    private void findViews() {
        ...
        imgSuggetions.setVisibility(View.GONE); // Don't have suggestions
        ...
        switch (view.getId()) {
            case R.id.btnUpdate:
                if(isValidInputByUser()) {
                    mIOnDeliveredUpdateListener.onDeliveredUpdateClickedListener(
