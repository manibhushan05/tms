...
public class OutwardPaymentData {
    ...
    public OutwardPaymentData(){}

    public OutwardPaymentData(String paymentDate, String amount, String modeOfPayment, String paidTo, String remarks, String remarksLabel) {
