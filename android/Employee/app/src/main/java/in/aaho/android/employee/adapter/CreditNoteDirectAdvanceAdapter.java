...
import in.aaho.android.employee.models.CreditNoteDirectAdvanceData;

/**
 * Created by Suraj.M
 */
public class CreditNoteDirectAdvanceAdapter extends RecyclerView.Adapter<CreditNoteDirectAdvanceAdapter.MyViewHolder> {
    private List<CreditNoteDirectAdvanceData> dataList;
    ...
    public CreditNoteDirectAdvanceAdapter(List<CreditNoteDirectAdvanceData> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_credit_note_direct_advance, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        CreditNoteDirectAdvanceData data = dataList.get(position);
