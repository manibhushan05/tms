...
public class StatusUpdateDialog extends Dialog implements
    ...
    public StatusUpdateDialog(Context context, ArrayList<String> statusList,
    ...
    private void showCommentSuggestionsListDialog() {
        ...
        alertbox.setTitle("Pick one suggestions for comment")
                .setItems(commentList, new DialogInterface.OnClickListener() {
