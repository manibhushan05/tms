 ...
 * Created by Suraj M
 */
public class BulkStatusUpdateRequest extends ApiPostRequest {
    ...
    public BulkStatusUpdateRequest(String id, String bookingStatus, ApiResponseListener listener) {
        super(Api.BULK_STATUS_UPDATE_URL, data(bookingStatus,id), listener);
    }

    private static JSONObject data(String bookingStatus,String id) {
