 ...
 * Created by Suraj M
 */
public class CommentUpdateRequest extends ApiPostRequest {
    public static final String KEY_BOOKING_STATUS_MAPPING_ID = "booking_status_mapping_id";
    public static final String KEY_COMMENT = "comment";

    public CommentUpdateRequest(Integer id, String comment, ApiResponseListener listener) {
        super(Api.COMMENT_UPDATE_URL, data(id,comment), listener);
    }
