...
import in.aaho.android.customer.adapter.PendingTransactionsAdapter;
...
public class PendingFragment extends Fragment {
    ...
    void SetupRecycleView(RecyclerView recList) {
        ...
        try {
            ...
            mAdapter = new PendingTransactionsAdapter(transactionsDataParser.getPendingTransactionDataArrayList());
