...
public class UserAddress {
    ...
    private static UserAddress instance = new UserAddress();

    public static UserAddress get() {
        return instance;
    }

    public static void updateAddress(JSONObject jsonObject) {
        instance.updateFromJson(jsonObject);
