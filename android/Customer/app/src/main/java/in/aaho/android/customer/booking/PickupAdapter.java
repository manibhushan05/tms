...
public class PickupAdapter extends RecyclerView.Adapter<PickupAdapter.MyViewHolder> implements LocationFormAdapter {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            city = (InstantAutoComplete) view.findViewById(R.id.pickup_city_edit_text);
            address = (InstantAutoComplete) view.findViewById(R.id.pickup_addr_edit_text);
            datetime = (EditText) view.findViewById(R.id.pickup_datetime_edit_text);
            addPickup = (Button) view.findViewById(R.id.more_pickup_addr_btn);
            delPickup = (Button) view.findViewById(R.id.del_pickup_addr_btn);
            addPickupLayout = (RelativeLayout) view.findViewById(R.id.pickup_add_layout);
