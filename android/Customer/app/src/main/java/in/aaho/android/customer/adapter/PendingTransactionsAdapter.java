...
public class PendingTransactionsAdapter extends RecyclerView.Adapter<PendingTransactionsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            tvTransactionId = (TextView) view.findViewById(R.id.tvPendingTransactionID);
            tvpickupFrom = (TextView) view.findViewById(R.id.tvQRPickupFrom);
            tvdropAt = (TextView) view.findViewById(R.id.tvQRDropAt);
            tvShipmentDate = (TextView) view.findViewById(R.id.tvPendingShipmentDate);
            tvNumberOfVehicle = (TextView) view.findViewById(R.id.tvPendingNumberOfTruck);
            btnNumberOfQuotes = (Button) view.findViewById(R.id.btnPendingViewQuotes);
//            tvMaterial = (TextView) view.findViewById(R.id.tvPendingMaterial);
            btnCancel = (Button) view.findViewById(R.id.btQRCancel);
            RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(R.id.rlPendingMainContent);
