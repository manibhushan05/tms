...
import in.aaho.android.customer.adapter.InTransitTransactionAdapter;
...
public class InTransitFragment extends Fragment {
    ...
    private ArrayList<InTransitTransactionData> inTransitTransactionDatas;
    private InTransitTransactionAdapter mAdapter;
    ...
    void SetupRecycleView(RecyclerView recList) {
        ...
        try {
            ...
            mAdapter = new InTransitTransactionAdapter(transactionsDataParser.getInTransitTransactionDataArrayList());
