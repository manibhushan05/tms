...
public class ShipmentDialogFragment extends BaseDialogFragment {
    ...
    private void setViewVariables() {
        ...
        shipDialogContainer = (RecyclerView) dialogView.findViewById(R.id.ship_dialog_container);
        customShipDialogContainer = (RecyclerView) dialogView.findViewById(R.id.custom_ship_dialog_container);
        truckCountTextView = (TextView) dialogView.findViewById(R.id.ship_dialog_shipment_msg_count);
        addCustomShipBtn = (TextView) dialogView.findViewById(R.id.custom_ship_add_btn);
        doneButton = (Button) dialogView.findViewById(R.id.ship_dialog_done_btn);
    }
