...
public class QuotationResponseAdapter extends RecyclerView.Adapter<QuotationResponseAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            tvResponseId = (TextView) view.findViewById(R.id.tvQuotationResponseNumber);
            tvResponseDateTime = (TextView) view.findViewById(R.id.tvQuotationResponseDatetime);
            tvVendorName = (TextView) view.findViewById(R.id.tvQuotationResponseVendorName);
            tvMessage = (TextView) view.findViewById(R.id.tvQuotationResponseMessage);
            btnAccept = (Button) view.findViewById(R.id.btQuotationAccept);
            btnDecline = (Button) view.findViewById(R.id.btQuotationDecline);
