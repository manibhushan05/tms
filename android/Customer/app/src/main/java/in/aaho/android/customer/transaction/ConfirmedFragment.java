...
import in.aaho.android.customer.adapter.ConfirmedTransactionAdapter;
...
public class ConfirmedFragment extends Fragment {
    ...
    private ConfirmedTransactionAdapter mAdapter;
    ...
    void SetupRecycleView(RecyclerView recList) {
        ...
        try {
            ...
            mAdapter = new ConfirmedTransactionAdapter(transactionsDataParser.getConfirmedTransactionDataArrayList());
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private ConfirmedFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ConfirmedFragment.ClickListener clickListener) {
