...
import in.aaho.android.customer.requests.VendorResponseRequest;
...
public class QuotationsAdapter extends RecyclerView.Adapter<QuotationsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            tvTransactionID = (TextView) view.findViewById(R.id.tvQuotationTransactionID);
            tvPickupFrom = (TextView) view.findViewById(R.id.tvQRPickupFrom);
            tvDropAt = (TextView) view.findViewById(R.id.tvQRDropAt);
            tvNumberOfTrucks = (TextView) view.findViewById(R.id.tvQuotationNumberOfTruck);
            tvShipmentDate = (TextView) view.findViewById(R.id.tvQuotationShipmentDate);
            btnNumberOfQuotes = (Button) view.findViewById(R.id.btQuotationNumberOfQuotions);
            btnCancel = (Button) view.findViewById(R.id.btQuotationCancel);
            relativeLayoutMainContent = (RelativeLayout) view.findViewById(R.id.rlQuotationMainContent);
