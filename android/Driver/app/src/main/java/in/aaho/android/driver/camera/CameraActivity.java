...
public class CameraActivity extends BaseActivity {
    ...
    private void setViewVariables() {
        cameraContainer = (RelativeLayout) findViewById(R.id.camera_container);
        reviewContainer = (RelativeLayout) findViewById(R.id.review_image_container);

        previewLayout = (FrameLayout) findViewById(R.id.camera_preview);

        captureButton = (ImageButton) findViewById(R.id.button_capture);
        recaptureButton = (ImageButton) findViewById(R.id.button_recapture);
        okButton = (ImageButton) findViewById(R.id.button_ok);
        flashToggle = (ImageButton) findViewById(R.id.button_flash);
        backButton = (ImageButton) findViewById(R.id.button_back);

        reviewImageView = (ImageView) findViewById(R.id.review_image_view);
    }
