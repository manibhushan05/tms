...
import in.aaho.android.aahocustomers.adapter.AahoOfficeSuggestionAdapter;
import in.aaho.android.aahocustomers.adapter.CitySuggestionAdapter;
import in.aaho.android.aahocustomers.adapter.VehicleTypeSuggestionAdapter;
import in.aaho.android.aahocustomers.adapter.CustomerSuggestionAdapter;
...
import in.aaho.android.aahocustomers.parser.CityParser;
import in.aaho.android.aahocustomers.parser.VehicleTypeParser;
import in.aaho.android.aahocustomers.parser.CustomerParser;
import in.aaho.android.aahocustomers.requests.RequirementRequest;
import in.aaho.android.aahocustomers.requests.LogoutRequest;
import in.aaho.android.aahocustomers.common.BaseActivity;
import in.aaho.android.aahocustomers.requests.RequirementUpdateRequest;
...
public class RequirementActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Requirement");
    ...
    private void setViewRefs() {
        ...
        linear_aahooffice_section.setVisibility(View.GONE);
        linear_vehicletype_section.setVisibility(View.GONE);
        linear_client_section.setVisibility(View.GONE);
        mRateTextInputLayout.setVisibility(View.GONE);
    ...
    private void makeReqSubmitRequest() {
        ...
        mClientId = Integer.parseInt(Prefs.get("customer_id"));
        mAahoOfficeId = Integer.parseInt(Prefs.get("aaho_office_id"));
    ...
    private void autoFillData(Bundle bundle) {
        if(bundle != null) {
            ...
            mSubmitButton.setText("Update Loads");
