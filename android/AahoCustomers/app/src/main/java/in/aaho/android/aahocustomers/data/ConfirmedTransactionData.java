...
public class ConfirmedTransactionData {
    ...
    public ConfirmedTransactionData(String allocatedVehicleId, String transactionId,
                                    String pickupFrom, String dropAt, String shipmentDate,
                                    String lrNumber, String material, String totalAmount,
                                    String balance, String paid, String vehicleNumber,
                                    String last_location, String transaction_id) {
    ...
    public void setTransactionId(String transaction_id) { this.transactionId = transaction_id; }

    public String getLastLocation() { return lastLocation; }

    public void setLastLocation(String last_location) { this.lastLocation = last_location; }
