...
import in.aaho.android.aahocustomers.loads.MyLoadsActivity;
import in.aaho.android.aahocustomers.requests.LogoutRequest;
import in.aaho.android.aahocustomers.support.ContactUsActivity;
import in.aaho.android.aahocustomers.transaction.FinancialsActivity;
...
public class LandingActivity extends BaseActivity
    ...
    private CardView cvMyTrips;
    private CardView cvMyFinancials;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aaho Customer");
...
//        cvMyTrips.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(LandingActivity.this, MyLoadsActivity.class));
//            }
//        });
        cvMyTrips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LandingActivity.this, TransactionActivity.class);
                startActivity(intent);
            }
        });

//        cvMyFinancials.setOnClickListener(new View.OnClickListener(){
//            @Override
//            public void onClick(View v){
//                Intent intent = new Intent(LandingActivity.this, FinancialsActivity.class);
//                startActivity(intent);
//            }
//        });
    }
    ...
    public void setViewVariables() {
        ...
        cvMyTrips = findViewById(R.id.card_view_my_trips);
//        cvTrack = findViewById(R.id.card_view_track_vehicle);
    }
