...
public class VehicleDocumentsActivity extends BaseActivity {
    ...
    private void launchRcEditDialog(Document doc) {
        ...
        String validityHint = "Registered Date";
    ...
    private void updateOwnerPanUI() {
        ...
        if(TextUtils.isEmpty(brokerVehicleDetails.ownerName) ||
                (brokerVehicleDetails.ownerName.equalsIgnoreCase("-"))) {
            ownerPanEditBtn.setVisibility(View.GONE);
            ownerDecEditBtn.setVisibility(View.GONE);
        } else {
    ...
    private void updateDriverDlUI() {
        ...
        if(TextUtils.isEmpty(brokerVehicleDetails.driverName) ||
                (brokerVehicleDetails.driverName.equalsIgnoreCase("-"))) {
            dlEditBtn.setVisibility(View.GONE);
        } else {
