...
import in.aaho.android.ownr.data.RequestedVehicleData;

/**
 * Created by mani on 3/8/16.
 */
class RequestedVehicleAdapter extends RecyclerView.Adapter<RequestedVehicleAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            tvTypeOfVehicle = view.findViewById(R.id.tvRvTypeOfVehicle);
            tvNumberOfVehicle = view.findViewById(R.id.tvRvNumberOfTrucks);
        }
    }
