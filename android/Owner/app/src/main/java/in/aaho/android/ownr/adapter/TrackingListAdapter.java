...
import in.aaho.android.ownr.data.TrackingDataList;
...
public class TrackingListAdapter extends RecyclerView.Adapter<TrackingListAdapter.UserViewHolder> {
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        UserViewHolder(View itemView) {
            super(itemView);
            cardView = itemView.findViewById(R.id.card_view_tracking_list);
            tvTransactionID = itemView.findViewById(R.id.transaction_id);
            tvStatus = itemView.findViewById(R.id.status);
            tvPickupFrom = itemView.findViewById(R.id.pickup_from);
            tvDropAt = itemView.findViewById(R.id.drop_at);
            tvStartedOn = itemView.findViewById(R.id.started_on);
            tvLastLocation = itemView.findViewById(R.id.last_location);
            tvLastLocationTime = itemView.findViewById(R.id.last_location_time);
        }
    }
