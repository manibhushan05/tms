...
import in.aaho.android.ownr.requests.VehicleDetailsRequest;
...
public class VehicleDetailsActivity extends BaseActivity {
    ...
    private void setClickListeners() {
        ...
        vehicleTripsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(VehicleDetailsActivity.this, TransactionNewActivity.class);
    ...
    private void sendVehicleEditRequest() {
        ...
        if (jsonObject != null && jsonObject.length() != 0) {
            VehicleAddEditRequest request = new VehicleAddEditRequest(
                    ...
                    new VehicleDetailsEditListener());
            queue(request);
        }
    }
    ...
    private void loadDataFromServer() {
        VehicleDetailsRequest appDataRequest = new VehicleDetailsRequest(vehicleId,
                new VehicleDetailsResponseListener());
    ...
    private void updateUI() {
        ...
        String type = brokerVehicleDetails.vehicleTypeName;
    ...
    private void updateOwnerUI() {
        String ownerName = brokerVehicleDetails.ownerName;
        if (TextUtils.isEmpty(ownerName)) {
            vehicleOwnerView.setText("-");
        } else {
            vehicleOwnerView.setText(ownerName);
        }
    ...
    private void updateDriverUI() {
        String ownerName = brokerVehicleDetails.driverName;
        if (TextUtils.isEmpty(ownerName)) {
            vehicleDriverView.setText("-");
        } else {
            vehicleDriverView.setText(ownerName);
        }
    ...
    private class VehicleDetailsResponseListener extends ApiResponseListener {
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
                ...
                brokerVehicleDetails = BrokerVehicleDetails.fromJsonObject(jsonObject);
                updateUI();
                hideSave();
            } catch (JSONException e) {
                e.printStackTrace();
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            try {
                ...
                Log.i("VehicleDeatailsActivity",errorMsg);
