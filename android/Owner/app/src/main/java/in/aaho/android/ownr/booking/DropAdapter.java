...
public class DropAdapter extends RecyclerView.Adapter<DropAdapter.MyViewHolder> implements LocationFormAdapter {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            city = view.findViewById(R.id.drop_city_edit_text);
            address = view.findViewById(R.id.drop_addr_edit_text);
            addDrop = view.findViewById(R.id.more_drop_addr_btn);
            delDrop = view.findViewById(R.id.del_drop_addr_btn);
            addDropLayout = view.findViewById(R.id.drop_add_layout);
