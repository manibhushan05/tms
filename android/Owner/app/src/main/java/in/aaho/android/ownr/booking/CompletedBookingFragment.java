...
public class CompletedBookingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_in_transit, container, false);
    ...
    void SetupRecycleView(RecyclerView recList) {
        ...
        try {
            ...
            mAdapter = new CompletedBookingAdapter(bookingDataParser.getCompletedBookingDataArrayList());
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private CompletedBookingFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final CompletedBookingFragment.ClickListener clickListener) {
