...
import in.aaho.android.ownr.requests.DriverAddEditRequest;
import in.aaho.android.ownr.requests.DriverDetailsRequest;
...
public class DriverDetailsActivity extends BaseActivity {
    ...
    private void sendDriverEditRequest() {
        ...
        if (jsonObject != null && jsonObject.length() != 0) {
            DriverAddEditRequest request = new DriverAddEditRequest(
                    brokerDriverDetails.id,jsonObject, new DriverDetailsEditListener());
            queue(request);
        }
    }
    ...
    private class DriverDetailsEditListener extends ApiResponseListener {
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
                ...
                BrokerDriverDetails driver = getDriverDetails(data);
    ...
    private BrokerDriverDetails getDriverDetails(JSONObject jsonObject) throws JSONException {
        ...
        return BrokerDriverDetails.fromJson(jsonObject);
    }
    ...
    private class DriverDetailsResponseListener extends ApiResponseListener {
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
                ...
                brokerDriverDetails = BrokerDriverDetails.fromJsonObject(jsonObject);
                updateUI();
                hideSave();
            } catch (JSONException e) {
                e.printStackTrace();
