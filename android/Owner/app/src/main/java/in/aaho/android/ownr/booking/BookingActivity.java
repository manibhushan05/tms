...
import in.aaho.android.ownr.requests.NewBookingRequest;
import in.aaho.android.ownr.requests.VendorRequest;
...
public class BookingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactNameEditText.setText(Utils.def(App.getProfile().userFullName, ""));
    ...
    private void setViewVariables() {
        ...
        resetButton = findViewById(R.id.reset_form_btn);
        shipAddButton = findViewById(R.id.more_ship_btn);
        noShipTextView = findViewById(R.id.no_ship_message);

        contactNameEditText = findViewById(R.id.other_details_name_edit_text);
        contactPhoneEditText = findViewById(R.id.other_details_phone_edit_text);
        materialEditText = findViewById(R.id.other_details_material_edit_text);
        rateEditText = findViewById(R.id.other_details_rate_edit_text);

        pickupContainer = findViewById(R.id.pickup_container);
        dropContainer = findViewById(R.id.drop_container);
        shipContainer = findViewById(R.id.ship_container);
        customShipContainer = findViewById(R.id.custom_ship_container);

        termsCheckBox = findViewById(R.id.booking_terms_checkbox);
        termsOpenTextView = findViewById(R.id.booking_terms_open_btn);
    }
