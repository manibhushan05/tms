...
import in.aaho.android.ownr.requests.VendorDeleteRequest;
...
public class ProfileVendorAdapter extends RecyclerView.Adapter<ProfileVendorAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            name = view.findViewById(R.id.profile_vendor_name_textview);
            phone = view.findViewById(R.id.profile_vendor_phone_textview);
            delete = view.findViewById(R.id.profile_vendor_delete_btn);
